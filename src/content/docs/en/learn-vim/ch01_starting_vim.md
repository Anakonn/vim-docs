---
description: This guide introduces various ways to start Vim from the terminal, covering
  installation and basic usage for Vim 8.2, Neovim, and older versions.
