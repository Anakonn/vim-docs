---
description: Learn to combine Vimscript data types through conditionals and loops,
  using relational operators to create basic programs in this informative chapter.
