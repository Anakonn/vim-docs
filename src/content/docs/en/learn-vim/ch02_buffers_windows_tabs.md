---
description: 'This document explains Vim''s display abstractions: buffers, windows,
  and tabs, along with setup instructions for efficient navigation and editing.'
